...
Finally, while `pace` here is a `lubridate` duration object, it's most easily understood in a "MM:SS" format: `pace_formatter` is provided for that: contrast the readability of the two pace graphs below, one without the formatter and the other with it:
